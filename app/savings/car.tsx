...
import { ArrowLeft, Calendar, Car } from "lucide-react-native";
import { ScrollView, Text, TouchableOpacity, View } from "react-native";

export default function CarSavingsScreen() {
  const router = useRouter();
  const { goals } = useGoal();

  const goal = goals.find((g) => g.name.toLowerCase().includes("car"));
  const targetAmount = goal?.targetAmount || 14390;
  ...
  return (
    <View className="flex-1 bg-primary">
      ...
      <View className="pt-12 pb-6 px-6 flex-row items-center justify-between">
        ...
        <Text className="text-xl font-bold text-text-dark">Car</Text>
        <TouchableOpacity>
      ...
      <ScrollView className="flex-1 bg-secondary rounded-t-3xl px-6 pt-8">
        <View className="bg-white rounded-3xl p-6 mb-6">
          <View className="flex-row justify-between items-start mb-6">
            ...
            <View className="w-24 h-24 rounded-2xl bg-blue-400 items-center justify-center">
              ...
              <Text className="text-white text-xs mt-2">Travel</Text>
            </View>
          </View>
          ...
          <View className="mb-4">
            ...
            <Text className="text-sm text-text-gray mt-2">
              ✓ {percentage.toFixed(0)}% Of Your Goal, Keep Going!
            </Text>
          </View>
        </View>
        ...
        <View className="mb-6">
          <View className="flex-row justify-between items-center mb-4">
            <Text className="text-lg font-semibold text-text-dark">July</Text>
            <TouchableOpacity>
            ...
            <View className="bg-white rounded-2xl p-4 flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <View>
                  ...
                  <Text className="text-sm text-text-gray">14:16 - July 5</Text>
                </View>
              </View>
              <Text className="text-base font-semibold text-text-dark">
                GH₵387.32
        ...
        <View className="mb-6">
          <View className="flex-row justify-between items-center mb-4">
            <Text className="text-lg font-semibold text-text-dark">May</Text>
          </View>
            ...
            <View className="bg-white rounded-2xl p-4 flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <View>
                  ...
                  <Text className="text-sm text-text-gray">21:45 - May 30</Text>
                </View>
              </View>
              <Text className="text-base font-semibold text-text-dark">
                GH₵122.99
            ...
            <View className="bg-white rounded-2xl p-4 flex-row items-center justify-between">
              <View className="flex-row items-center">
                ...
                <View>
                  ...
                  <Text className="text-sm text-text-gray">14:25 - May 05</Text>
                </View>
              </View>
              <Text className="text-base font-semibold text-text-dark">
                GH₵85.94
